...
davinci_mtm::davinci_mtm()
{
  ...
  camera_sub_ = n.subscribe<sensor_msgs::Joy>("/dvrk/footpedals/camera",10,&davinci_mtm::cameraCallback,this);
  clutch_sub_ = n.subscribe<sensor_msgs::Joy>("/dvrk/footpedals/clutch",10,&davinci_mtm::clutchCallback,this);
}
